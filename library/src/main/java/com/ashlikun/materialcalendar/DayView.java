...
import static com.ashlikun.materialcalendar.MaterialCalendarView.showDecoratedDisabled;
import static com.ashlikun.materialcalendar.MaterialCalendarView.showOtherMonths;
import static com.ashlikun.materialcalendar.MaterialCalendarView.showOutOfRange;
...
class DayView extends AppCompatCheckedTextView {
    ...
    private com.ashlikun.materialcalendar.CalendarDay date;
    ...
    public DayView(Context context, com.ashlikun.materialcalendar.CalendarDay day) {
        super(context);
    ...
    public void setDay(com.ashlikun.materialcalendar.CalendarDay date) {
        this.date = date;
        setText(getLabel());
    }
