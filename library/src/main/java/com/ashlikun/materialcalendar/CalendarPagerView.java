...
import static com.ashlikun.materialcalendar.MaterialCalendarView.SHOW_DEFAULTS;
import static com.ashlikun.materialcalendar.MaterialCalendarView.showOtherMonths;
...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener, View.OnLongClickListener {
    ...
    private com.ashlikun.materialcalendar.CalendarDay firstViewDay;
    ...
    public CalendarPagerView(@NonNull MaterialCalendarView view,
                             com.ashlikun.materialcalendar.CalendarDay firstViewDay,
                             int firstDayOfWeek,
    ...
    protected abstract boolean isDayEnabled(com.ashlikun.materialcalendar.CalendarDay day);
    ...
    public void setMinimumDate(com.ashlikun.materialcalendar.CalendarDay minDate) {
        this.minDate = minDate;
        updateUi();
    }

    public void setMaximumDate(com.ashlikun.materialcalendar.CalendarDay maxDate) {
        this.maxDate = maxDate;
        updateUi();
    }

    public void setSelectedDates(Collection<com.ashlikun.materialcalendar.CalendarDay> dates) {
        for (DayView dayView : dayViews) {
            com.ashlikun.materialcalendar.CalendarDay day = dayView.getDate();
