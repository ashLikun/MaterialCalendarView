...
import com.ashlikun.materialcalendar.CalendarMode;
import com.ashlikun.materialcalendar.CalendarPager;
import com.ashlikun.materialcalendar.CalendarPagerAdapter;
import com.ashlikun.materialcalendar.CalendarPagerView;
import com.ashlikun.materialcalendar.CalendarUtils;
import com.ashlikun.materialcalendar.DayView;
import com.ashlikun.materialcalendar.DayViewDecorator;
import com.ashlikun.materialcalendar.DirectionButton;
import com.ashlikun.materialcalendar.MonthPagerAdapter;
...
import com.ashlikun.materialcalendar.TitleChanger;
import com.ashlikun.materialcalendar.WeekPagerAdapter;
import com.ashlikun.materialcalendar.format.ArrayWeekDayFormatter;
import com.ashlikun.materialcalendar.format.DateFormatTitleFormatter;
import com.ashlikun.materialcalendar.format.DayFormatter;
import com.ashlikun.materialcalendar.format.MonthArrayTitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    private final com.ashlikun.materialcalendar.DirectionButton buttonPast;
    private final com.ashlikun.materialcalendar.DirectionButton buttonFuture;
    private final com.ashlikun.materialcalendar.CalendarPager pager;
    private com.ashlikun.materialcalendar.CalendarPagerAdapter<?> adapter;
    private com.ashlikun.materialcalendar.CalendarDay currentMonth;
    private LinearLayout topbar;
    private com.ashlikun.materialcalendar.CalendarMode calendarMode;
    /**
     * Used for the dynamic calendar height.
     */
    private boolean mDynamicHeightEnabled;

    private final ArrayList<com.ashlikun.materialcalendar.DayViewDecorator> dayViewDecorators = new ArrayList<>();
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        buttonPast = new com.ashlikun.materialcalendar.DirectionButton(getContext());
        buttonPast.setContentDescription(getContext().getString(com.ashlikun.materialcalendar.R.string.previous));
        title = new AppCompatTextView(getContext());
        buttonFuture = new com.ashlikun.materialcalendar.DirectionButton(getContext());
        buttonFuture.setContentDescription(getContext().getString(com.ashlikun.materialcalendar.R.string.next));
        pager = new com.ashlikun.materialcalendar.CalendarPager(getContext());
        ...
        TypedArray a = context.getTheme()
                .obtainStyledAttributes(attrs, com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView, 0, 0);
        try {
            int calendarModeIndex = a.getInteger(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_calendarMode,
                    0
            );
            firstDayOfWeek = a.getInteger(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_firstDayOfWeek,
                    -1
            );

            titleChanger.setOrientation(
                    a.getInteger(com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_titleAnimationOrientation,
                            VERTICAL));

            if (firstDayOfWeek < 0) {
                firstDayOfWeek = com.ashlikun.materialcalendar.CalendarUtils.getInstance().getFirstDayOfWeek();
            }

            showWeekDays = a.getBoolean(com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_showWeekDays, true);

            newState()
                    .setFirstDayOfWeek(firstDayOfWeek)
                    .setCalendarDisplayMode(com.ashlikun.materialcalendar.CalendarMode.values()[calendarModeIndex])
                    .setShowWeekDays(showWeekDays)
                    .commit();

            setSelectionMode(a.getInteger(
                com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_selectionMode,
                SELECTION_MODE_SINGLE
            ));

            final int tileSize = a.getLayoutDimension(com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_tileSize, INVALID_TILE_DIMENSION);
            if (tileSize > INVALID_TILE_DIMENSION) {
                setTileSize(tileSize);
            }

            final int tileWidth = a.getLayoutDimension(com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_tileWidth, INVALID_TILE_DIMENSION);
            if (tileWidth > INVALID_TILE_DIMENSION) {
                setTileWidth(tileWidth);
            }

            final int tileHeight = a.getLayoutDimension(com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_tileHeight, INVALID_TILE_DIMENSION);
            if (tileHeight > INVALID_TILE_DIMENSION) {
                setTileHeight(tileHeight);
            }

            setArrowColor(a.getColor(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_arrowColor,
                    Color.BLACK
            ));
            Drawable leftMask = a.getDrawable(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_leftArrowMask
            );
            if (leftMask == null) {
                leftMask = getResources().getDrawable(com.ashlikun.materialcalendar.R.drawable.mcv_action_previous);
            }
            setLeftArrowMask(leftMask);
            Drawable rightMask = a.getDrawable(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_rightArrowMask
            );
            if (rightMask == null) {
                rightMask = getResources().getDrawable(com.ashlikun.materialcalendar.R.drawable.mcv_action_next);
            }
            setRightArrowMask(rightMask);

            setSelectionColor(
                    a.getColor(
                            com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_selectionColor,
                            getThemeAccentColor(context)
                    )
            );

            CharSequence[] array = a.getTextArray(com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_weekDayLabels);
            if (array != null) {
                setWeekDayFormatter(new ArrayWeekDayFormatter(array));
            }

            array = a.getTextArray(com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_monthLabels);
            if (array != null) {
                setTitleFormatter(new MonthArrayTitleFormatter(array));
            }

            setHeaderTextAppearance(a.getResourceId(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_headerTextAppearance,
                    com.ashlikun.materialcalendar.R.style.TextAppearance_MaterialCalendarWidget_Header
            ));
            setWeekDayTextAppearance(a.getResourceId(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_weekDayTextAppearance,
                    com.ashlikun.materialcalendar.R.style.TextAppearance_MaterialCalendarWidget_WeekDay
            ));
            setDateTextAppearance(a.getResourceId(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_dateTextAppearance,
                    com.ashlikun.materialcalendar.R.style.TextAppearance_MaterialCalendarWidget_Date
            ));
            //noinspection ResourceType
            setShowOtherDates(a.getInteger(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_showOtherDates,
                    SHOW_DEFAULTS
            ));

            setAllowClickDaysOutsideCurrentMonth(a.getBoolean(
                    com.ashlikun.materialcalendar.R.styleable.MaterialCalendarView_mcv_allowClickDaysOutsideCurrentMonth,
                    true
            ));
        } catch (Exception e) {
            e.printStackTrace();
        ...
        currentMonth = com.ashlikun.materialcalendar.CalendarDay.today();
    ...
    private void setupChildren() {
        ...
        pager.setId(com.ashlikun.materialcalendar.R.id.mcv_pager);
        ...
        switch (mode) {
            ...
            case SELECTION_MODE_SINGLE:
                if (oldMode == SELECTION_MODE_MULTIPLE || oldMode == SELECTION_MODE_RANGE) {
                    ...
                    List<com.ashlikun.materialcalendar.CalendarDay> dates = getSelectedDates();
                    if (!dates.isEmpty()) {
    ...
    public CharSequence getCalendarContentDescription() {
        return calendarContentDescription != null
                ...
                : getContext().getString(com.ashlikun.materialcalendar.R.string.calendar);
    }
     ...
     */
    public com.ashlikun.materialcalendar.CalendarDay getSelectedDate() {
        List<com.ashlikun.materialcalendar.CalendarDay> dates = adapter.getSelectedDates();
        if (dates.isEmpty()) {
            return null;
        } else {
     ...
     */
    @NonNull
    public List<com.ashlikun.materialcalendar.CalendarDay> getSelectedDates() {
    ...
    public void clearSelection() {
        ...
        for (com.ashlikun.materialcalendar.CalendarDay day : dates) {
    ...
    public void setSelectedDate(@Nullable Calendar calendar) {
        setSelectedDate(com.ashlikun.materialcalendar.CalendarDay.from(calendar));
    }
    ...
    public void setSelectedDate(long date) {
        setSelectedDate(com.ashlikun.materialcalendar.CalendarDay.from(date));
    }

    /**
     * @param date a Date to set as selected. Null to clear selection
     */
    public void setSelectedDate(@Nullable com.ashlikun.materialcalendar.CalendarDay date) {
        clearSelection();
        if (date != null) {
    ...
    public void setDateSelected(@Nullable Calendar calendar, boolean selected) {
        setDateSelected(com.ashlikun.materialcalendar.CalendarDay.from(calendar), selected);
    }
    ...
    public void setDateSelected(long date, boolean selected) {
        setDateSelected(com.ashlikun.materialcalendar.CalendarDay.from(date), selected);
    }
     ...
     * @param selected true if day should be selected, false to deselect
     */
    public void setDateSelected(@Nullable com.ashlikun.materialcalendar.CalendarDay day, boolean selected) {
        if (day == null) {
            return;
        }
    ...
    public void setCurrentDate(@Nullable Calendar calendar) {
        setCurrentDate(com.ashlikun.materialcalendar.CalendarDay.from(calendar));
    }
    ...
    public void setCurrentDate(long date) {
        setCurrentDate(com.ashlikun.materialcalendar.CalendarDay.from(date));
    }

    /**
     * @return The current month shown, will be set to first day of the month
     */
    public com.ashlikun.materialcalendar.CalendarDay getCurrentDate() {
     ...
     */
    public void setCurrentDate(@Nullable com.ashlikun.materialcalendar.CalendarDay day) {
     ...
     */
    public void setCurrentDate(@Nullable com.ashlikun.materialcalendar.CalendarDay day, boolean useSmoothScroll) {
        if (day == null) {
            return;
        }
     ...
     */
    public com.ashlikun.materialcalendar.CalendarDay getMinimumDate() {
        return minDate;
    }
     ...
     */
    public com.ashlikun.materialcalendar.CalendarDay getMaximumDate() {
        return maxDate;
    }
    ...
    /**
     * Get the current {@link com.ashlikun.materialcalendar.CalendarMode} set of the Calendar.
     *
     * @return Whichever mode the calendar is currently in.
     */
    public com.ashlikun.materialcalendar.CalendarMode getCalendarMode() {
        return calendarMode;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        clearSelection();
        for (com.ashlikun.materialcalendar.CalendarDay calendarDay : ss.selectedDates) {
    ...
    private void setRangeDates(com.ashlikun.materialcalendar.CalendarDay min, com.ashlikun.materialcalendar.CalendarDay max) {
        com.ashlikun.materialcalendar.CalendarDay c = currentMonth;
    ...
    public static class SavedState extends BaseSavedState {
        ...
        com.ashlikun.materialcalendar.CalendarDay minDate = null;
        com.ashlikun.materialcalendar.CalendarDay maxDate = null;
        List<com.ashlikun.materialcalendar.CalendarDay> selectedDates = new ArrayList<>();
        ...
        com.ashlikun.materialcalendar.CalendarMode calendarMode = com.ashlikun.materialcalendar.CalendarMode.MONTHS;
        com.ashlikun.materialcalendar.CalendarDay currentMonth = null;
        ...
        public void writeToParcel(@NonNull Parcel out, int flags) {
            ...
            out.writeInt(calendarMode == com.ashlikun.materialcalendar.CalendarMode.WEEKS ? 1 : 0);
        ...
        private SavedState(Parcel in) {
            ...
            ClassLoader loader = com.ashlikun.materialcalendar.CalendarDay.class.getClassLoader();
            minDate = in.readParcelable(loader);
            maxDate = in.readParcelable(loader);
            in.readTypedList(selectedDates, com.ashlikun.materialcalendar.CalendarDay.CREATOR);
            ...
            calendarMode = in.readInt() == 1 ? com.ashlikun.materialcalendar.CalendarMode.WEEKS : com.ashlikun.materialcalendar.CalendarMode.MONTHS;
     ...
     */
    public void addDecorators(Collection<? extends com.ashlikun.materialcalendar.DayViewDecorator> decorators) {
        if (decorators == null) {
            return;
        }
     ...
     * @param decorators decorators to add
     */
    public void addDecorators(com.ashlikun.materialcalendar.DayViewDecorator... decorators) {
     ...
     */
    public void addDecorator(com.ashlikun.materialcalendar.DayViewDecorator decorator) {
        if (decorator == null) {
            return;
        }
     ...
     */
    protected void dispatchOnDateSelected(final com.ashlikun.materialcalendar.CalendarDay day, final boolean selected) {
        if (listener != null) {
     ...
     */
    protected void dispatchOnRangeSelected(final com.ashlikun.materialcalendar.CalendarDay firstDay, final com.ashlikun.materialcalendar.CalendarDay lastDay) {
        final OnRangeSelectedListener listener = rangeListener;
        final List<com.ashlikun.materialcalendar.CalendarDay> days = new ArrayList<>();
        ...
        while (counter.before(end) || counter.equals(end)) {
            final com.ashlikun.materialcalendar.CalendarDay current = com.ashlikun.materialcalendar.CalendarDay.from(counter);
     ...
     */
    protected void dispatchOnMonthChanged(final com.ashlikun.materialcalendar.CalendarDay day) {
    ...
    /**
     * Call by {@link com.ashlikun.materialcalendar.CalendarPagerView} to indicate that a day was clicked and we should handle it.
     ...
     */
    protected void onDateClicked(@NonNull com.ashlikun.materialcalendar.CalendarDay date, boolean nowSelected) {
        switch (selectionMode) {
            ...
            break;
            case SELECTION_MODE_RANGE: {
                final List<com.ashlikun.materialcalendar.CalendarDay> currentSelection = adapter.getSelectedDates();
                ...
                if (currentSelection.size() == 0) {
                    ...
                    final com.ashlikun.materialcalendar.CalendarDay firstDaySelected = currentSelection.get(0);
                    adapter.setDateSelected(date, nowSelected);
     ...
     */
    public void selectRange(final com.ashlikun.materialcalendar.CalendarDay firstDay, final com.ashlikun.materialcalendar.CalendarDay lastDay) {
        clearSelection();
     ...
     * @param dayView
     */
    protected void onDateClicked(final com.ashlikun.materialcalendar.DayView dayView) {
        final com.ashlikun.materialcalendar.CalendarDay currentDate = getCurrentDate();
        final com.ashlikun.materialcalendar.CalendarDay selectedDate = dayView.getDate();
        final int currentMonth = currentDate.getMonth();
        final int selectedMonth = selectedDate.getMonth();

        if (calendarMode == com.ashlikun.materialcalendar.CalendarMode.MONTHS
    ...
    /**
     * Call by {@link com.ashlikun.materialcalendar.CalendarPagerView} to indicate that a day was long clicked and we should handle it
     *
     * @param dayView
     */
    protected void onDateLongClicked(final com.ashlikun.materialcalendar.DayView dayView) {
     ...
     */
    protected void onDateUnselected(com.ashlikun.materialcalendar.CalendarDay date) {
    ...
    private int getWeekCountBasedOnMode() {
        ...
        boolean isInMonthsMode = calendarMode.equals(com.ashlikun.materialcalendar.CalendarMode.MONTHS);
    ...
    public class State {
        private final com.ashlikun.materialcalendar.CalendarMode calendarMode;
        private final int firstDayOfWeek;
        private final com.ashlikun.materialcalendar.CalendarDay minDate;
        private final com.ashlikun.materialcalendar.CalendarDay maxDate;
    ...
    public class StateBuilder {
        private com.ashlikun.materialcalendar.CalendarMode calendarMode = com.ashlikun.materialcalendar.CalendarMode.MONTHS;
         ...
         */
        public StateBuilder setCalendarDisplayMode(com.ashlikun.materialcalendar.CalendarMode mode) {
        ...
        public StateBuilder setMinimumDate(@Nullable Calendar calendar) {
            setMinimumDate(com.ashlikun.materialcalendar.CalendarDay.from(calendar));
            return this;
        }
        ...
        public StateBuilder setMinimumDate(long date) {
            setMinimumDate(com.ashlikun.materialcalendar.CalendarDay.from(date));
            return this;
        }
         ...
         * @param calendar set the minimum selectable date, null for no minimum
         */
        public StateBuilder setMinimumDate(@Nullable com.ashlikun.materialcalendar.CalendarDay calendar) {
            minDate = calendar;
            return this;
        }
        ...
        public StateBuilder setMaximumDate(@Nullable Calendar calendar) {
            setMaximumDate(com.ashlikun.materialcalendar.CalendarDay.from(calendar));
            return this;
        }
        ...
        public StateBuilder setMaximumDate(long date) {
            setMaximumDate(com.ashlikun.materialcalendar.CalendarDay.from(date));
            return this;
        }
         ...
         * @param calendar set the maximum selectable date, null for no maximum
         */
        public StateBuilder setMaximumDate(@Nullable com.ashlikun.materialcalendar.CalendarDay calendar) {
            maxDate = calendar;
            return this;
        }
    ...
    private void commit(State state) {
        ...
        com.ashlikun.materialcalendar.CalendarDay calendarDayToShow = null;
        if (adapter != null && state.cacheCurrentPosition) {
            ...
            if (calendarMode != state.calendarMode) {
                com.ashlikun.materialcalendar.CalendarDay currentlySelectedDate = getSelectedDate();
                if (calendarMode == com.ashlikun.materialcalendar.CalendarMode.MONTHS && currentlySelectedDate != null) {
                    ...
                    com.ashlikun.materialcalendar.CalendarDay lastVisibleCalendarDay = com.ashlikun.materialcalendar.CalendarDay.from(lastVisibleCalendar);
        ...
        // Recreate adapter
        final com.ashlikun.materialcalendar.CalendarPagerAdapter<?> newAdapter;
        switch (calendarMode) {
            case MONTHS:
